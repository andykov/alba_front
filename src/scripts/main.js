$(function () {
  ...
  $('.js-slider-round .product').hover(
    function () {
      $(this).parent('.slider-round__item').css('z-index', 2)
    }, function () {
      $(this).parent('.slider-round__item').css('z-index', 1);
    }
  );
  (function () {
    var sliderRoundItem = document.querySelectorAll('.js-slider-round .product');
    for (var i = 0; i < sliderRoundItem.length; i++) {
